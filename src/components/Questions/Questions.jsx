    ...
    <div className='pt-10'>
      <div className='text-xl font-semibold py-10 border p-5 space-y-2'>
        ...
        <details className='space-y-2'>
          <summary>What is the difference of props & state  ?</summary>
        ...
        <details>
          ...
          <p className='text-slate-700'>UseState is a hook in react. It's allow us to add state functional components. It returns an array with two values 1. The current state and function to update it.</p>
        </details>
        <details>
