...
const SideCart = ({ cart, book }) => {
  ...
  return (
    <div className="sticky top-0">
      <div className="p-5 w-80 lg:w-96  border-violet-600 border rounded-lg font-semibold text-xl text-violet-800 bg-red-100">
        <h1>Spent time on read: {countTime}</h1>
      </div>
      <div className="bg-violet-300 w-80 bg-opacity-70 p-5 mt-5 rounded-lg lg:w-96 space-y-2">
